...
```java
AgentConfig config = AgentConfig.builder()
    .persona("You are a specialized developer.")
...
```java
AgentConfig config = AgentConfig.builder()
    .persona("You are restricted from running dangerous commands.")
...
```java
AgentConfig config = AgentConfig.builder()
    .persona("You are an observed agent.")
