...
/**
 * A definition of a tool, containing its name, description, and JSON schema for
 * its parameters. This class wraps the internal protobuf representation.
 */
		...
		public Builder parametersSchema(Class<?> targetClass) {
			try {
				...
				throw new RuntimeException(
						"Failed to generate JSON schema for tool parameters: " + targetClass.getName(), e);
			}
			return this;
		}
